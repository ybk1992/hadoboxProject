    ...
    <div class="row">
        <div class="col-md-11 seller">
        	...
        	<c:if test="${mem_userid eq book_List[0].book_sellid}">
	        	<button class="btn btn-secondary" onclick="location.href='update.do?book_num=${list[0].book_num}'">수정하기</button>
				<button class="btn btn-secondary" onclick="location.href='book_List.do'">목록보기</button>
				<button class="btn btn-secondary" onclick="chkDelete(${list[0].book_num })">삭제하기</button>
